...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            <li><a href="logout.php" class="logout"><i class='bx bx-log-out-circle'></i>Sair</a></li>
        </ul>
    </div>
        ...
        <main>
            ...
            <div class="form-container">
                ...
                <form id="roteiro-form" action="salvar_roteiro.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="localizacao">Valores Gastos:</label>
                        <div id="localizacao-valor-container">
                            <div class="localizacao-valor-item">
                                <input type="text" name="localizacao[]" id="localizacao" placeholder="Descrição" required>
